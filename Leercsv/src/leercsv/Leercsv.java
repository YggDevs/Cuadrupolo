       ...
       /*JFrame frame = new JFrame("GUILLENEIZER");      
		...
		try
		{
			//csv archivo que contiene los datos
			 strFile = "C:\\airelab1View2.csv";
                         strFile1 = "C:\\airelab2View2.csv";
                         strFile2 = "C:\\airelab3View2.csv";
                         strFile3 = "C:\\airelab4View2.csv";
          ...
          System.out.println("CO2_2--------------------------------------"+ Carbon_dioxide2);
           ...
           System.out.println("--------------------------------------");   
            System.out.println("                                      ");  
             ...
             double resultadoHelio = (dobleHelium+dobleHelium1+dobleHelium2+dobleHelium3)/4;
             double resultadoArgon36 = (dobleArgon36+dobleArgon361+dobleArgon362+dobleArgon363)/4;
             double resultadoArgon40 = (dobleArgon40+dobleArgon401+dobleArgon402+dobleArgon403)/4;
             double resultadodobleCarbon_dioxide = (dobleCarbon_dioxide+dobleCarbon_dioxide1+dobleCarbon_dioxide2+dobleCarbon_dioxide3)/4;
